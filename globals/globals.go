...
var AmplitudeZipFilePath *string
...
func Init() bool {
	...
	AmplitudeAPIKey = flag.String("amplitudeAPI", "", "Amplitude API key")
	AmplitudeSecretKey = flag.String("amplitudeSecret", "", "Amplitude Secret key")
	AmplitudeZipFilePath = flag.String("amplitudeZipFilePath", "", "Absolute path to amplitude "+
		"zip file")
	...
	if *ImportService == "amplitude" && (*AmplitudeSecretKey == "" || *AmplitudeAPIKey == "" || *AmplitudeEnd == "" ||
		*AmplitudeStart == "" || *AmplitudeZipFilePath == "") {
		log.Println("Importing from Amplitude requires Amplitude secret key, API key, Amplitude zip file path, " +
			"start, and end time")
		return false
	}
